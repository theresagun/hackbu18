...
class Game(tools.States):
    ...
    def setup_btns(self):
        ...
        self.blue_button = button.Button((10,45,25,25),self.blue,
            lambda:self.set_color(self.blue), clicked_color=c,  hover_color=(252,183,18), **button_config
        )
        self.red_button = button.Button((50,45,25,25),self.red,
            lambda:self.set_color(self.red), clicked_color=c,  hover_color=(243,112,32), **button_config
        )
        self.green_button = button.Button((90,45,25,25),self.green,
            lambda:self.set_color(self.green), clicked_color=c,  hover_color=(205,0,77), **button_config
        )
        self.yellow_button = button.Button((10,80,25,25),self.yellow,
            lambda:self.set_color(self.yellow), clicked_color=c,  hover_color=(100,96,172), **button_config
        )
        self.pink_button = button.Button((50,80,25,25),self.pink,
            lambda:self.set_color(self.pink), clicked_color=c,  hover_color=(0,138,210), **button_config
        )
        self.purple_button = button.Button((90,80,25,25),self.purple,
            lambda:self.set_color(self.purple), clicked_color=c,  hover_color=(12,177,75), **button_config
        )
        self.buttons += [
